...
describe("PlaylistSorter.getSortTypes — bedrock integration", () => {
  // BEDROCK INTEGRATION: the sort gate must report all five sort types as
...
describe("PlaylistSorter — bedrock sort execution on viewmodel", () => {
